...
class DataAugmentationDINO_Test(object):
    def __init__(self):
...
class ImageNetSubset(data.Dataset):
    def __init__(self, subset_file='/gmiha/data001/RnD/SSV/Users/Roy_U/projects/diffusion_clustering/dino/imagenet_100.txt', root='/gmiha/data001/RnD/SSV/Datasets/imagenet/', split='train',
                 transform=None):
